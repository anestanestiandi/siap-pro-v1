                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="tanggal_kunjungan" name="tanggal_kunjungan" placeholder="mm/dd/yyyy" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-[#3B5286] focus:ring focus:ring-[#3B5286] focus:ring-opacity-50 h-10 pl-4 bg-white" autocomplete="off">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="waktu" name="waktu_mulai" placeholder="--:--" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-[#3B5286] focus:ring focus:ring-[#3B5286] focus:ring-opacity-50 h-10 pl-4 bg-white" autocomplete="off">
                                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-400">
