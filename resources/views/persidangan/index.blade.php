        ...
        <div class="-mt-2 mb-10">
            ...
            <div x-show="!loading" x-cloak class="relative group">
                ...
                <div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false"
                    class="relative w-60 flex-shrink-0 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-3 border border-blue-200 flex justify-between hover:shadow-md transition">
                    <div>
                        <div
                            ...
                            <div x-show="exportOpen" 
                                ...
                                style="display: none;">
                                 ...
                                 <div @click.outside="exportOpen = false"
                                     class="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden transform transition-all">
                        ...
                        <tbody class="divide-y divide-gray-100" x-show="!loading" x-cloak
                            ...
                            @forelse($kegiatan as $item)
                                <tr class="hover:bg-[#EFF6FF] transition">
                                    ...
                                    {{-- Nama Kegiatan --}}
                                    <td class="px-3 py-4 text-left">
                                        <p class="font-semibold text-gray-900 line-clamp-3" title="{{ $item->nama_persidangan }}">{{ $item->nama_persidangan }}</p>
                                    </td>
