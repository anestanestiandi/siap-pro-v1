    ...
    <div x-data="{
        ...
        <div class="-mt-2 mb-10">
            ...
            <div x-show="!loading" x-cloak x-transition:enter="transition ease-out duration-500"
                ...
                <div
                    class="w-60 flex-shrink-0 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-3 border border-blue-200 flex justify-between hover:shadow-md transition">
                    <div>
                        <div
                ...
                {{-- 3. Dynamic Jenis Pelayanan Cards --}}
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="px-6 py-4 border-b border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-[#3B5286] text-white">
                        ...
                        <div x-data="{ exportOpen: false, exportFormat: 'pdf', selectAll: true, columns: { tanggal: true, waktu: true, nama_kegiatan: true, jenis_pelayanan: true, anggota_dewan: true, tempat: true } }" 
                            ...
                            <div x-show="exportOpen" 
                                ...
                                <div @click.outside="exportOpen = false"
                                    class="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden transform transition-all text-left">
