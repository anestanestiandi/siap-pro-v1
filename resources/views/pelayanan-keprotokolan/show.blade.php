<x-app-layout :item="$item">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        {{-- Back Button --}}
        <div class="mb-4">
            <a href="{{ route('pelayanan-keprotokolan') }}" class="inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-[#3B5286] transition-colors">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-8 py-5 border-b border-gray-50 flex items-center justify-between">
                        ...
                        <span
                            ...
                            {{ $item->jenisPelayanan?->nama_jenis ?? 'Internal Group' }}
                        </span>
                    </div>
                    <div class="p-8">
                        <div class="space-y-8">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-6 text-sm text-gray-500">
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <span class="font-medium">{{ $item->tanggal_kegiatan ? $item->tanggal_kegiatan->isoFormat('dddd, D MMMM Y') : '-' }}</span>
                                    </div>
                                    <div class="flex items-center gap-2.5">
                                        <div class="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400">
                                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        ...
                                        <span class="font-medium">{{ $item->waktu ? \Carbon\Carbon::parse($item->waktu)->format('H:i') . ' WIB' : '-' }}</span>
                                    </div>
                                    <div class="flex items-center gap-2.5">
                                        <div class="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400">
                                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        ...
                                        <span class="font-medium">{{ $item->tempat ?? '-' }}</span>
                                    </div>
                                </div>
                            </div>
